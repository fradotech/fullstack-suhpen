...
import { VariantIndexRequest } from '@server/modules/inventory/variant/infrastructure/variant-index.request'
import {
  VariantCreateRequest,
  VariantUpdateRequest,
} from '@server/modules/inventory/variant/infrastructure/variant.request'
