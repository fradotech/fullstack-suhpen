...
import { DashboardInventoryApp } from './modules/dashboard-inventory/v1/dashboard-inventory.app'
import { DashboardInventoryController } from './modules/dashboard-inventory/v1/dashboard-inventory.controller'
