...
export class Milestone11693286246414 implements MigrationInterface {
    name = 'Milestone11693286246414'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_e335c71614a82f585fee87a490" ON "region_provinces" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_3cd41bdad0bcdcdc2c4a425d1b" ON "region_provinces" ("oid") `);
        await queryRunner.query(`CREATE TABLE "region_cities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" uuid, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_by_id" uuid, "deleted_at" TIMESTAMP, "deleted_by_id" uuid, "name" character varying NOT NULL, "oid" integer NOT NULL, "province_id" uuid, CONSTRAINT "PK_a039dba7d5b94e1473d7f1eb64b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_a3ba9f537e62ece513d24d87ef" ON "region_cities" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_76ea014b46e3121f84ae109ab9" ON "region_cities" ("oid") `);
        await queryRunner.query(`CREATE TABLE "region_districts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" uuid, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_by_id" uuid, "deleted_at" TIMESTAMP, "deleted_by_id" uuid, "name" character varying NOT NULL, "oid" integer NOT NULL, "city_id" uuid, CONSTRAINT "PK_ef8313120a6b6203ca9d226de5c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_dd895212680b4c6cb3480ac558" ON "region_districts" ("name") `);
        await queryRunner.query(`CREATE INDEX "IDX_0e5a6d12b0453a2d8a6909032e" ON "region_districts" ("oid") `);
        ...
        await queryRunner.query(`ALTER TABLE "region_cities" ADD CONSTRAINT "FK_b7899b48309db161ff50b12ea51" FOREIGN KEY ("province_id") REFERENCES "region_provinces"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "region_districts" ADD CONSTRAINT "FK_41b2e1394824c6c03182bc5508e" FOREIGN KEY ("city_id") REFERENCES "region_cities"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "region_districts" DROP CONSTRAINT "FK_41b2e1394824c6c03182bc5508e"`);
        await queryRunner.query(`ALTER TABLE "region_cities" DROP CONSTRAINT "FK_b7899b48309db161ff50b12ea51"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0e5a6d12b0453a2d8a6909032e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_dd895212680b4c6cb3480ac558"`);
        await queryRunner.query(`DROP TABLE "region_districts"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_76ea014b46e3121f84ae109ab9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a3ba9f537e62ece513d24d87ef"`);
        await queryRunner.query(`DROP TABLE "region_cities"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_3cd41bdad0bcdcdc2c4a425d1b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_e335c71614a82f585fee87a490"`);
