...
export class Milestone11690373424959 implements MigrationInterface {
    name = 'Milestone11690373424959'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ent_notification_user_read" ("ent_push_notification_id" uuid NOT NULL, "ent_user_id" uuid NOT NULL, CONSTRAINT "PK_250bd1b02fe929150e78acbda56" PRIMARY KEY ("ent_push_notification_id", "ent_user_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_5c43bf733b2d2fdb4233e1ba59" ON "ent_notification_user_read" ("ent_push_notification_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_01707d2ce828076aaca0a761b8" ON "ent_notification_user_read" ("ent_user_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "ent_notification_user_read" ADD CONSTRAINT "FK_5c43bf733b2d2fdb4233e1ba596" FOREIGN KEY ("ent_push_notification_id") REFERENCES "ent_push_notification"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "ent_notification_user_read" ADD CONSTRAINT "FK_01707d2ce828076aaca0a761b87" FOREIGN KEY ("ent_user_id") REFERENCES "ent_user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`CREATE TABLE "query-result-cache" ("id" SERIAL NOT NULL, "identifier" character varying, "time" bigint NOT NULL, "duration" integer NOT NULL, "query" text NOT NULL, "result" text NOT NULL, CONSTRAINT "PK_6a98f758d8bfd010e7e10ffd3d3" PRIMARY KEY ("id"))`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE "query-result-cache"`);
        await queryRunner.query(`ALTER TABLE "ent_notification_user_read" DROP CONSTRAINT "FK_01707d2ce828076aaca0a761b87"`);
        await queryRunner.query(`ALTER TABLE "ent_notification_user_read" DROP CONSTRAINT "FK_5c43bf733b2d2fdb4233e1ba596"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_01707d2ce828076aaca0a761b8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_5c43bf733b2d2fdb4233e1ba59"`);
        await queryRunner.query(`DROP TABLE "ent_notification_user_read"`);
