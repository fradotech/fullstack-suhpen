...
export class Milestone11693283158186 implements MigrationInterface {
    name = 'Milestone11693283158186'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "iam_role_permissions" ("iam_permissions_id" uuid NOT NULL, "iam_roles_id" uuid NOT NULL, CONSTRAINT "PK_2b18c3e99a65f5b6484734cf522" PRIMARY KEY ("iam_permissions_id", "iam_roles_id"))`);
