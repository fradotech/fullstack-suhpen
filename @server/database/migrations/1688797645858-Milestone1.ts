...
export class Milestone11688797645858 implements MigrationInterface {
    name = 'Milestone11688797645858'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ent_inventory" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" uuid, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_by_id" uuid, "deleted_at" TIMESTAMP, "deleted_by_id" uuid, "sku" character varying, "variant" character varying, "supply_type" character varying NOT NULL DEFAULT 'Self Stock', "buy_price" integer NOT NULL DEFAULT '0', "sell_price" integer NOT NULL DEFAULT '0', "margin_price" integer NOT NULL DEFAULT '0', "stock" integer NOT NULL DEFAULT '0', "stock_minimum" integer, "discount_percentage" integer NOT NULL DEFAULT '0', "expired_date" TIMESTAMP, "is_active" boolean NOT NULL DEFAULT true, "thumbnail" character varying, "product_id" uuid, CONSTRAINT "UQ_8bdc043871831e7e679e8af0052" UNIQUE ("sku"), CONSTRAINT "PK_ae28c34ce8765b3ed8b251d980a" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ent_inventory" DROP CONSTRAINT "FK_70e3a6b7fcd07c80a2472f8f3b4"`);
